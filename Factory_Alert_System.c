...
//	{
//		// P2.9 – connect external push button
//		PINSEL4 &= ~(3 << 20);         
//		FIO2DIR &= ~BUTTON_PIN;
//	}
...
//    LCD_gotoxy(1,1);         // Move cursor to first line
//    LCD_puts((U8 *)msg);     // Display message
//	}

///* ---------------------------------------------------------------------------------------------------------------- */
///* --- TASK CREATION  --- */
//	
//	/* ----- Task A - Indicating Shift Changes in the Factory ----- */
//	/*
//	Uses LCD Display to indicate the Shift Changes.
//	LED1 glows during the process.
//	*/
...
//	/* ----- Task B - Auto pressure triggering ----- */
//	/*
//	Uses LCD Display to indicate the alert the pressure variation with the value.
//	LED2 glows during the process.
//	*/
...
//							
//						os_mut_wait(&lcd_mutex, 0xFFFF);
//					  os_mut_wait(&buzzer_mutex, 0xFFFF);
//  
//						//vnp cr s
//						FIO2SET = LED5;
//						FIO2CLR = LED2;
...
//	/* ----- Task C - Manual Alert trigger ----- */
//	/*
//	LED3 glows during the process.
//	Buzzer will buzz continuously.
//	*/
//__task void TaskC(void)  
//	{
//    while(1)
//			{
//				if (!(FIO2PIN & BUTTON_PIN))   // Check Button pressed (active low)
//        {
//					FIO2SET = LED3;
//					
//					os_mut_wait(&buzzer_mutex, 0xFFFF);
...
//					//vnp cr
//        }
//        os_dly_wait(10);   // check every few ms
//			}
//	}

//	/* ----- Task Creation ----- */
//	/*
//	Buzzer and LCD are the two shared resources. (mutex will be assigned to it)
//	*/
...
//		taskA_id = os_tsk_create(TaskA, 1);
//    taskB_id = os_tsk_create(TaskB, 3);
//    taskC_id = os_tsk_create(TaskC, 2);
